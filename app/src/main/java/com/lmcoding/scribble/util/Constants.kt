package com.lmcoding.scribble.util

object Constants {

    const val USE_LOCALHOST = false

    const val HTTP_BASE_URL = "https://powerful-tor-43937.herokuapp.com/"
    const val HTTP_BASE_URL_LOCALHOST = "http://10.0.2.2:8001/"

    const val WS_BASE_URL = "https://powerful-tor-43937.herokuapp.com/ws/draw"
